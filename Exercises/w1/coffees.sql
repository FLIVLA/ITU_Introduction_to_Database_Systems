...
INSERT INTO Drinkers( name, address, phone ) VALUES( 'Bjorn Jonsson','ITU', 12345678 );
INSERT INTO Drinkers( name, address, phone ) VALUES( 'Johan Sivertsen','ITU', 87654321 );

INSERT INTO Likes( drinker, coffee, rating ) VALUES( 'Bjorn Jonsson', 'Blue Mountain', 10);
...
INSERT INTO Frequents( drinker, coffeehouse ) VALUES( 'Bjorn Jonsson', 'Analog' );
...
-- Query
SELECT * FROM Likes;
SELECT COUNT(*) AS NumberOfCoffeehouses FROM Coffeehouses;
SELECT name FROM Drinkers WHERE phone > 50000000;